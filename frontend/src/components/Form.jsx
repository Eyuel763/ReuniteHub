...
const Form = () => {
    ...
    return (
        <fieldset className="border-2 border-gray-300 p-4 relative rounded-xl max-w-4xl ">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="m-5">
                    ...
                    <textarea
                        ...
                        placeholder="• Enter details like height, weight, skin tone.
        • Distinctive features (e.g., scars, tattoos, traditional clothing)."
                    />
                </div>
                ...
                <h2 className="text-3xl font-bold my-3.5 text-left">Upload Photos</h2>
                ...
                <div
                    {...getRootProps()}
                    className={`border-1 w-full sm:w-80 h-28 p-4 rounded-l flex justify-center items-center m-3 hover:cursor-pointer ${
                ...
                >
                    ...
                    {isDragActive ? (
                        ...
                        <p className="text-left">Drag and drop</p>
                    )}
                </div>
