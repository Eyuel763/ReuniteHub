...
const Header = () => {
  ...
  const homeNavItems = [
    ...
    { label: 'Partnership', colorClass: 'text-green-500 hover:text-green-600' },
    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <Link to="/SubmitForm" className="text-gray-600 hover:text-blue-500 transition-colors">
            Submit Form
          </Link>
        ...
        <div className="hidden md:flex space-x-3 ml-6">
          <button className="px-3 py-1.5 border border-red-500 text-red-500 rounded-md hover:bg-red-50 transition-colors text-sm">
            Report 
          </button>
      ...
      <div className={`md:hidden fixed inset-y-0 right-0 w-64 bg-white shadow-xl transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out z-50`}>
        <div className="p-4 flex flex-col space-y-4">
          ...
          <Link to="/submitform" className="text-gray-600 hover:text-blue-500 transition-colors py-2">
            Submit Form
          </Link>
          ...
          <div className="border-t border-gray-200 pt-4">
            <button className="w-full px-3 py-2 border border-red-500 text-red-500 rounded-md hover:bg-red-50 transition-colors text-sm mb-2">
              Report Issue
            </button>
