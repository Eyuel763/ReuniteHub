...
from .views import MissingPersonViewSet, SuccessStoryListView, SuccessStoryDetailView, UrgentMissingPersonListView, SuccessStoryUpdateView
...
urlpatterns = [
    ...
    path('success-stories/<int:missing_person_id>/update/', SuccessStoryUpdateView.as_view(), name='success-story-update')
]
